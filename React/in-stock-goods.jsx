...
class SearchBar extends React.Component{
	...
	render(){
		return(
			<form>
			<input type='text' value={this.props.filterText} ref={(input) => this.filterTextInput=input} onChange = {this.handleChange} placeholder='Search...'/>
			<p>
